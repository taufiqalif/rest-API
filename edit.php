...
$api = http_request("http://localhost/rest_api/api/api_edit.php?id=" . $_GET["id"]);
...
<head>
    ...
    <link rel="stylesheet" href="readapi/layout/css/style.css">
</head>
        ...
        <div class="badan">
            ...
            <div class="content">
                ...
                <div id="stylish" class="myform">
                    ...
                    <form action="./api/api_edit.php" method="post" id="form">
